...
void desenharAudiograma(int valores[], char simbolo, char lado[]) {
    int db, i;

    printf("\n=====================================\n");
    printf("AUDIOGRAMA - ORELHA %s (%c)\n", lado, simbolo);
    printf("=====================================\n");
    printf("dB  | 500Hz  2000Hz  4000Hz\n");
    printf("-------------------------------------\n");

    for (db = 0; db <= 100; db += 10) {
        printf("%3d |", db);

        for (i = 0; i < 3; i++) {
            if (valores[i] >= db && valores[i] < db + 10)
                printf("   %c   ", simbolo);
            else
                printf("       ");
        }
...
int main() {
    ...
    char endereco[100], tel[12], opc, grauPerda[30], aparelhoTipo[40], usaAparelho;
    ...
    do {
        printf("O paciente faz uso de aparelho auditivo? Digite S para sim ou N para nao: ");
        scanf(" %c", &usaAparelho);

        if (usaAparelho != 'S' && usaAparelho != 'N')
            printf("ERRO: Digite apenas S ou N.\n");

    } while (usaAparelho != 'S' && usaAparelho != 'N');
    ...
    if (usaAparelho == 'S') {
        ...
        strcpy(aparelhoTipo, "Nao utiliza aparelho auditivo");
    }
    ...
    if (usaAparelho == 'S') {
        ...
        for (e = 0; e < 3; e++) {
            printf("| %6d Hz | %9d | %9d | ", frequencia[e], ouvidoE[e], aparelhoE[e]);
        ...
        printf("+------------+------------+\n");
        printf("| Frequencia | Perda (dB) |\n");
        printf("+------------+------------+\n");

        for (e = 0; e < 3; e++) {
            printf("| %6d Hz | %9d |\n", frequencia[e], ouvidoE[e]);
        }
    ...
    if (usaAparelho == 'S') {
        ...
        for (e = 0; e < 3; e++) {
            printf("| %6d Hz | %9d | %9d | ", frequencia[e], ouvidoD[e], aparelhoD[e]);
    ...
    desenharAudiograma(ouvidoD, 'O', "DIREITA");
    desenharAudiograma(ouvidoE, 'X', "ESQUERDA");

    printf("\nLegenda:\n");
    printf("O = Orelha direita\n");
    printf("X = Orelha esquerda\n");
